...
public class BaseTag extends JeecgTag {
	...
	public StringBuffer end(){
		...
		if(oConvertUtils.isIn("vue", types)){
			sb.append("<script type=\"text/javascript\" src=\"plug-in/element/vue-2.2.2.js\"></script>");
			sb.append("<script type=\"text/javascript\" src=\"plug-in/element/vue-resource-1.5.0.js\"></script>");
			sb.append("<script type=\"text/javascript\" src=\"plug-in/element/element-1.4.13.min.js\"></script>");
			sb.append("<link rel=\"stylesheet\" href=\"plug-in/element/css/element-1.4.13.min.css\" type=\"text/css\"></link>");
		}
		if (oConvertUtils.isIn("bootstrap-table2", types)) {
			sb.append("<link rel=\"stylesheet\" href=\"plug-in/bootstrap-table/bootstrap-table.min.css\" type=\"text/css\"></link>");
			sb.append("<script type=\"text/javascript\" src=\"plug-in/bootstrap-table/bootstrap-table.js\"></script>");
			sb.append("<script type=\"text/javascript\" src=\"plug-in/bootstrap-table/locale/bootstrap-table-zh-CN.min.js\"></script>");
			sb.append("<script type=\"text/javascript\" src=\"plug-in/themes/bootstrap-ext/js/common.js\"></script>");
			sb.append("<script type=\"text/javascript\" src=\"plug-in/themes/bootstrap-ext/js/bootstrap-curdtools.js\"></script>");
		}
